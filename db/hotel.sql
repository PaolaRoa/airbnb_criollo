...
CREATE TABLE IF NOT EXISTS `houses` (
  ...
  `parking_lot` ENUM("Si", "No") NULL,
  `internet` ENUM("Si", "No") NULL,
...
CREATE TABLE IF NOT EXISTS `Bookings` (
  ...
  `users_idusers` INT NOT NULL,
  `housesId` INT NOT NULL,
  `total` FLOAT NOT NULL,
  PRIMARY KEY (`idBookings`),
  INDEX `fk_Bookings_users1_idx` (`users_idusers` ASC),
  INDEX `fk_Bookings_houses1_idx` (`housesId` ASC),
  CONSTRAINT `fk_Bookings_users1`
    FOREIGN KEY (`users_idusers`)
    REFERENCES `users` (`idusers`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Bookings_houses1`
    FOREIGN KEY (`housesId`)
...
-- -----------------------------------------------------
-- Table `additional_services_help`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `additional_services_help` (
  `houses_idhouses` INT NOT NULL,
